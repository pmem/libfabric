/**
 * Copyright (c) 2015-2017 NVIDIA CORPORATION & AFFILIATES. All rights reserved.
 *
 ...
 * @param context   User-define context, from stream.cb_context;
 *
 ...
 *
 */
typedef size_t (*sharp_stream_cb)(void *buffer, size_t length,
...
struct sharp_coll_data_desc {
	...
	union {
		...
		/* Streaming data */
		struct {
			sharp_stream_cb cb;	/**< Streaming callback. */
			void *cb_context;	/**< Context for stream callback. */
 ...
 *
 * This descriptor defines the input parameters for SHARP coll reduce operation
 *
 */
 ...
 *
 * This descriptor defines the input paramaters for SHARP coll broadcast operation
 *
 */
 ...
 * @return Error code as defined by @ref sharp_error_no
 */
int sharp_coll_caps_query(struct sharp_coll_context *context,
 ...
 */
int sharp_coll_do_reduce(struct sharp_coll_comm *comm,
			 struct sharp_coll_reduce_spec *spec);
 ...
 * @note Not implemented.
 */
int sharp_coll_do_reduce_nb(struct sharp_coll_comm *comm,
			    struct sharp_coll_reduce_spec *spec,
			    void **handle);
/**
 ...
 * @note Not implemented.
 */
int sharp_coll_do_bcast(struct sharp_coll_comm *comm,
 ...
 * @note Not implemented.
 */
int sharp_coll_do_bcast_nb(struct sharp_coll_comm *comm,
			   struct sharp_coll_bcast_spec *spec,
			   void **handle);
 ...
 *
 */
int sharp_coll_reg_mr(struct sharp_coll_context *context,
